                      ...
                      <div class="col-md-4 totala">
                          <div class="total-amount">
                              <ul>
                                  ...
                                  <li><span>Cart Subtotal</span><a href="#">
                                    $ {{ $cart_subtotal }}
                                    <input type="hidden" name="cart_subtotal" value="{{ $cart_subtotal }}">
                                  </a></li>
                                  <li><span>(+) Shipping</span><a href="#">
                                    $ {{ $shipping }}
                                    <input type="hidden" name="shipping" value="{{ $shipping }}">
                                  </a></li>
                                  <li><span>(-) Discount</span><a href="#">
                                    $ {{ $discount }}
                                    <input type="hidden" name="discount" value="{{ $discount }}">
                                  </a></li>
                                  <li><span>Grand Total</span><a href="#">
                                    $ {{ $grand_total }}
                                    <input type="hidden" name="grand_total" value="{{ $grand_total }}">
                                  </a></li>
                                  @if (isset($coupon_amount))
                                    <li><span>(-) Coupon Discount</span><a href="#">
                                      $ {{ $coupon_amount }}%
                                      <input type="hidden" name="coupon_discount" value="{{ $coupon_amount }}">
                                    </a></li>
                                    <li><span>After Coupon Discount</span><a href="#">
                          ...
                          <div class="payments">
                              <div class="payment-head">
                                  <h3>Payments</h3>
                                  <label for="aa"> <input id="aa" type="radio" name="payment_type" value="1"> CASH ON DELIVERY</label>
                                  <br>
                                  <label for="aa1"> <input id="aa1" type="radio" name="payment_type" value="2"> PAYPAL</label>

                                  {{-- <div class="checkbox chek2 checkbox-success check33">
                                      <input id="checkbox111" type="checkbox">
                                      <label for="checkbox111">Direct Bank Transfer</label>
                                  </div>

                                  <div class="checkbox chek2 checkbox-success check33">
                                      <input id="checkbox112" type="checkbox">
                                      <label for="checkbox112">CHEQUE PAYMENT</label>
                                  </div>
                                  <div class="checkbox chek2 checkbox-success check33">
                                      <input id="checkbox113" type="checkbox">
                                      <label for="checkbox113">paypal</label>
                                  </div> --}}
                                  <div class="procd">
