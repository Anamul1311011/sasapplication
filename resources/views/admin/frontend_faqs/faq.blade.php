            ...
            <div class="modal fade" id="adding" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content rounded-0 border-0">
                        ...
                        <form action="{{route('insert_frontend_faqs')}}" method="post">
                            @csrf
            ...
            <table class="table table-hover text-center">
                ...
                <tbody>
                    ...
                    <tr class="tr-shadow bg-white">
                        ...
                        <td style="vertical-align:middle; font-size:25px;" class="py-4">{!! $faq->icon !!}</td>
                        <td style="vertical-align:middle;" class="py-4">{{$faq->title}}</td>
                                ...
                                <div class="modal fade" id="edit{{$faq->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                        <div class="modal-content rounded-0 border-0">
                                            ...
                                            <form action="{{route('update_frontend_faqs')}}" method="post">
                                                @csrf
                                                <div class="modal-body text-left">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="font-weight-bold">Title or Question</label>
                                                        <input type="text" name="Utitle" class="form-control{{ $errors->has('Utitle') ? ' is-invalid' : '' }}" value="{{$faq->title}}">
                                ...
                                <script>
                                    function testing{{$faq->id}}() {
                                        swal({
                                            ...
                                            .then((willDelete) => {
                                                if (willDelete) {
                                                    location.href = "{{route('delete_frontend_faq',$faq->id)}}"
                                                }
                                        });
                                    }
                                </script>
