             ...
             <div class="card-body">
               ...
               <table class="table table-bordered">
                 ...
                 @elseif($order->main_category == "service")
                  @php $sohel=App\Service::where('id',$order->product_id)->first(); @endphp
                 ...
                 @php
                   ...
                   $total    = ($sohel->price*$order->product_quantity)-$discount-$coupon;
                 @endphp
                   <tr>
                      <td>{{ $sohel->title }}</td>
                      <td>{{ $sohel->price }}</td>
                 ...
                 <tr>
                   <td colspan="4"></td>
                   <td colspan="2"  style="text-align:right;">Grand Total = {{ $grand_total+15 }}</td>
                 </tr>
               </table>
             </div>
          </div>
